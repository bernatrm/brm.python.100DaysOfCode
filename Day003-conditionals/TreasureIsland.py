...
if left_right == "right":
    ...
    if swim_wait == "swim":
        ...
        red_yellow_blue = input("Someone pass with a little ship and invite you to cross the river with him, then you walk on a new road and at one point you find three doors flagged as 'Red', 'Yellow' or 'Blue'... Which one would you choose to open? \n").lower()
